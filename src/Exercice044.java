...
/*
 * v1 = < 3.0, 2.0, 5.0 > v2 = < 1.0, 2.0, 3.0 > v1 + v2 = < 4.0, 4.0, 8.0 >
 * v1.v2 = 22.0
 */

/*
 * autre facon d'Ècrire somme : return new Vecteur3d (v.x+w.x, v.y+w.y, v.z+w.z)
 * ;
 * 
 * au lieu de v3.affiche(), on pourrait (Vecteur3d.somme(v1, v2)).affiche() ;
 * 
 * v1.pScal(v2) ou v2.pScal(v1) Avec statique, ce serait plus symÈtrique :
 * 
 */