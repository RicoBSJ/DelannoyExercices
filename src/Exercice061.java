...
class PointNom extends PointOmega {
...
public class Exercice061 {
	public static void main(String args[]) {
		PointOmega p = new PointOmega();
		p.setPoint(2, 5);
		p.affCoord();
...
/*
 * Coordonnees : 2 5 Point de nom A Coordonnees : 1 7 Point de nom A Coordonnees
 * : 10 10 Point de nom B Coordonnees : 4 3 Coordonnees : 4 3
 */