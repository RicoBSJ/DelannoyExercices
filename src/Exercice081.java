...
/*
 * nb mots lus en données On utilise méthode simple de tri (bulle) On a interet
 * a trier les références On aurait pu garder un index ????
 */

/*
 * Combien de mots ? 5 donnez vos mots javaScript Pascal BaSiC Java ADA Liste
 * par ordre alphabetique : ADA BaSiC Java javaScript Pascal
 */
